                          ...
                          <form action="{{route('register')}}" method="post">
                           @csrf
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                              <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Enviar datos</button>
